...
class ManagerMenuDialog extends ComfyDialog {
	...
	createControlsLeft() {
		...
		this.local_mode_checkbox.checked = true;
		...
		this.proxy_checkbox = $el("input",{type:'checkbox', id:"proxy_checkbox"},[])
        const proxy_checkbox_text = $el("label",{for:"proxy_checkbox"},[" Use Mirror"])
        proxy_checkbox_text.style.color = "var(--fg-color)";
        proxy_checkbox_text.style.cursor = "pointer";
		...
		return [
			...
			$el("div", {}, [this.proxy_checkbox, proxy_checkbox_text] ),
				...
				$el("div.comfy-modal-content",
					[
						$el("tr.cm-title", {width:"100%"}, [
								$el("font", {size:6, color:"white"}, [`ComfyUI Manager-DZ Menu`])]
							),
						$el("br", {}, []),
...
app.registerExtension({
	...
	async setup() {
		...
		mirrorButton.textContent = "Manager DZ";
