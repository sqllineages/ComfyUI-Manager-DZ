...
try:
    ...
    print(f"[ComfyUI-Manager-DZ] Logging failed: {e}")
...
def check_bypass_ssl():
    try:
        ...
        if 'bypass_ssl' in default_conf and default_conf['bypass_ssl'].lower() == 'true':
            print(f"[ComfyUI-Manager-DZ] WARN: Unsafe - SSL verification bypass option is Enabled. (see ComfyUI-Manager/config.ini)")
...
def get_installed_packages():
    ...
    if pip_list is None:
        try:
            ...
            print(f"[ComfyUI-Manager-DZ] Failed to retrieve the information of installed pip packages.")
            return set()
...
if os.path.exists(restore_snapshot_path):
    try:
        ...
        print(f"[ComfyUI-Manager-DZ] Restore snapshot.")
        ...
        with open(restore_snapshot_path, 'r', encoding="UTF-8") as json_file:
            ...
            for url in cloned_repos:
                try:
                    ...
                    if this_exit_code != 0:
                        print(f"[ComfyUI-Manager-DZ] Restoring '{repository_name}' is failed.")
        ...
        if exit_code != 0:
            print(f"[ComfyUI-Manager-DZ] Restore snapshot failed.")
        else:
            print(f"[ComfyUI-Manager-DZ] Restore snapshot done.")
...
if os.path.exists(script_list_path):
    print("\n#######################################################################")
    print("[ComfyUI-Manager-DZ] Starting dependency installation/(de)activation for the extension\n")
        ...
        for line in file:
            ...
            try:
                ...
                if script[1].startswith('#'):
                    ...
                    print(f"\n## ComfyUI-Manager-DZ: EXECUTE => {script[1:]}")
                    ...
                    print(f"\n## ComfyUI-Manager-DZ: CANCELED => {script[1:]}")
    ...
    print("\n[ComfyUI-Manager-DZ] Startup script completed.")
    print("#######################################################################\n")
